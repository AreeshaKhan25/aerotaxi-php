<?php
// Ported from: legal/terms-of-service.blade.php
?>
<?php require BASE_PATH . '/templates/layouts/header.php'; ?>
<?php $__page_title = 'Terms of Service - AeroTAXI'; ?>
    ...
    <section class="py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl p-8 shadow-sm">
                ...
                <p class="text-gray-600 mb-6">
                    We collect and process personal data only as necessary to provide our services, fulfil bookings, and communicate with you. For full details on how we collect, use, store, and protect your personal data, please refer to our <a href="<?= base_url('privacy-policy') ?>" class="text-primary hover:underline">Privacy Policy</a>.
                </p>
