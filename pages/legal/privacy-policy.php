<?php
// Ported from: legal/privacy-policy.blade.php
?>
<?php require BASE_PATH . '/templates/layouts/header.php'; ?>
<?php $__page_title = 'Privacy Policy - AeroTAXI'; ?>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl p-8 shadow-sm">
                ...
                <ul class="list-disc pl-6 text-gray-600 mb-6 space-y-1">
                    ...
                    <li>Cookies and similar tracking technologies (see our <a href="<?= base_url('cookie-policy') ?>" class="text-primary hover:underline">Cookie Policy</a> for more details)</li>
                </ul>
                ...
                <p class="text-gray-600 mb-6">
                    Our website uses cookies and similar technologies to enhance your browsing experience, analyse site traffic, and personalise content. For detailed information about the cookies we use and how to manage your cookie preferences, please refer to our <a href="<?= base_url('cookie-policy') ?>" class="text-primary hover:underline">Cookie Policy</a>.
                </p>
